library just_audio_desktop;

import 'package:flutter/services.dart';
import 'dart:io';

final MethodChannel _channel = MethodChannel('just_audio');
...
class AudioPlayer {
  ...
  ///
  ///     await audioPlayer.setFilePath('/path/to/file.mp3');
  ///
  ...
  ///
  /// 2) `'\\path\\to\\file.mp3'`
  Future<bool> setFilePath(String fileLocation) async {
  ...
  ///
  ///     await audioPlayer.seek(Duration(seconds: 18));
  ///
